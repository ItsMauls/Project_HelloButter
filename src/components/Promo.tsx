...
return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-8 mt-4 w-5/6 mx-auto">
        <Image width={500} height={500} className="rounded-xl w-full h-auto" src="https://milkbarstore.com/cdn/shop/files/HomepageLeft_2.jpg?format=pjpg&v=1700526255&width=720" alt=""/>
        <Image width={500} height={500} className="rounded-xl w-full h-auto" src="https://milkbarstore.com/cdn/shop/files/HomepageLeft_2.jpg?format=pjpg&v=1700526255&width=720" alt=""/>
        <div id="promo" className="col-span-2 sm:col-span-1 text-center mt-4 sm:mt-0">
            <h1 className="text-2xl">
                Nikmati Promo Hari Ini!
            </h1>
            <h1 className="text-4xl sm:text-7xl py-2">
                Promo Kue Murah
            </h1>
            <p>
